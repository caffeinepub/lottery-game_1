...
export class Backend implements backendInterface {
    ...
    async buyTicket(arg0: UserId): Promise<TicketId> {
        if (this.processError) {
            try {
                const result = await this.actor.buyTicket(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllTicketsByUser(arg0: UserId): Promise<Array<Ticket>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTicketsByUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTicket(arg0: TicketId): Promise<Ticket> {
        if (this.processError) {
            try {
